...
describe('Hub API', () => {
  ...
  describe('POST /hub', () => {
    it('should create a subscription', async () => {
      ...
      const res = await app.request('/tmf-api/productCatalogManagement/v4/hub', {
        method: 'POST',
  ...
  describe('DELETE /hub/:id', () => {
    it('should delete a subscription', async () => {
      ...
      const deleteRes = await app.request(
        `/tmf-api/productCatalogManagement/v4/hub/${created.id}`,
        { method: 'DELETE' }
      )
    ...
    it('should return 404 for non-existent subscription', async () => {
      const res = await app.request(
        '/tmf-api/productCatalogManagement/v4/hub/00000000-0000-0000-0000-000000000000',
        { method: 'DELETE' }
      )
